...
void main() {
	shaderColours[0] = vec3(15.0f, 56.0f, 15.0f) / 255.0f;					
	shaderColours[1] = vec3(15.0f + 20, 56.0f + 20, 15.0f + 20) / 255.0f;	

	shaderColours[2] = vec3(48.0f, 98.0f, 48.0f) / 255.0f;					
	shaderColours[3] = vec3(48.0f + 20, 98.0f + 20, 48.0f + 20) / 255.0f;	
	
	shaderColours[4] = vec3(139.0f, 172.0f, 15.0f) / 255.0f;
	shaderColours[5] = vec3(139.0f + 20, 172.0f + 20, 15.0f + 20) / 255.0f;
	
	shaderColours[6] = vec3(155.0f, 188.0f, 15.0f) / 255.0f;
	shaderColours[7] = vec3(155.0f + 20, 188.0f + 20, 15.0f + 20) / 255.0f;
